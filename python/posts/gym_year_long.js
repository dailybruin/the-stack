...
const labels = ['January','February','March','April','May', 'June', 'July', 'August', 'September', 'October', 'November', 'December']; //THIS SHOULD BE A LIST OF WHAT YOU WANT ON THE X-AXIS
const colors = ['rgb(255, 200, 87)', 'rgb(28, 93, 153)'] //CHANGE THESE TO WHAT MATCHES THE SUBJECT
const data = {
  labels: labels,
  ...
  datasets: [{
    label: 'BFIT',
    data:[3868, 36495, 32054, 41305, 36624, 10073, 7928, 8013, 8488, 35557, 29626, 9516], //VALUE FOR EACH POINT
    backgroundColor: colors[0],
    borderColor: colors[0],
    borderWidth: 1
  },{
    label: 'Wooden',
    data: [13731, 63633, 61066, 85295, 76599, 32322, 33040, 34921, 37166, 73931, 58250, 23298], //DATA HERE
