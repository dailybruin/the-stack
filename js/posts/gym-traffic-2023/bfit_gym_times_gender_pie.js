...
const data = {
  ...
  datasets: [{
    label: 'Gender distrbution at BFIT',
    data:[112797, 143989, 12, 519, 50, 5, 3, 2], //VALUE FOR EACH SEGMENT
...
const options = {
  title: {
    display: true,
    text: 'Gender Distribution at BFIT',
    fontSize: 14
  },
    legend: {
      position: 'right',
...
const ctxPIE = document.getElementById('bfit_gender_demo_gym_times').getContext('2d');
