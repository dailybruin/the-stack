!(function(a, b) {
  ...
  function l(a) {
    var g,
      ...
      h = 0,
      i = 1;
    for (45 === a.charCodeAt(0) && ((b = 1), (i = -1)), b; b < d.length; b++)
      (g = k(d.charCodeAt(b))), (h = 60 * h + g);
    for (b = 0; b < e.length; b++)
      (f /= 60), (g = k(e.charCodeAt(b))), (h += g * f);
    return h * i;
  }
  function m(a) {
    for (var b = 0; b < a.length; b++) a[b] = l(a[b]);
  }
  function n(a, b) {
  ...
  function u() {
    var d,
      ...
      b = new r(new Date(a, 0, 1)),
      c = [b];
    for (f = 1; f < 48; f++)
      (e = new r(new Date(a, f, 1))),
        e.offset !== b.offset &&
          ((d = t(b, e)), c.push(d), c.push(new r(new Date(d.at + 6e4)))),
        (b = e);
    for (f = 0; f < 4; f++)
      c.push(new r(new Date(a + f, 0, 1))),
        c.push(new r(new Date(a + f, 6, 1)));
    return c;
  }
  function v(a, b) {
  ...
  function w(a, b) {
    var c, d;
    for (m(b), c = 0; c < b.length; c++)
      (d = b[c]), (f[d] = f[d] || {}), (f[d][a] = !0);
  }
  function x(a) {
    var g,
      h,
    ...
    for (g = 0; g < b; g++) {
      i = f[a[g].offset] || {};
      for (h in i) i.hasOwnProperty(h) && (c[h] = !0);
    }
    for (g in c) c.hasOwnProperty(g) && d.push(e[g]);
    return d;
  }
  function y() {
    try {
    ...
    for (i = 0; i < f.length; i++) {
      for (h = new s(C(f[i]), d), j = 0; j < d; j++) h.scoreOffsetAt(c[j]);
      g.push(h);
    }
    return g.sort(v), g.length > 0 ? g[0].zone.name : void 0;
  }
  function z(a) {
    return (g && !a) || (g = y()), g;
  }
  ...
  function C(a, b) {
    ...
    return f instanceof q
      ...
      : 'string' == typeof f
        ? ((f = new q(f)), (c[a] = f), f)
        : d[a] && b !== C && (g = C(d[a], C))
          ? ((f = c[a] = new q()), f._set(g), (f.name = e[a]), f)
          : null;
  }
  function D() {
    var a,
      b = [];
    for (a in e)
      e.hasOwnProperty(a) && (c[a] || c[d[a]]) && e[a] && b.push(e[a]);
    return b.sort();
  }
  function E(a) {
    var b, c, f, g;
  ...
  function F(a) {
    B(a.zones), E(a.links), (J.dataVersion = a.version);
  }
  function G(a) {
    return (
      G.didShowError ||
  ...
  function J(b) {
    ...
    return (
      e && !a.isMoment(b) && H(f) && f.add(e.parse(f), 'minutes'), f.tz(d), f
    );
  }
  function L(a) {
    return function() {
    ...
    return (
      I(
        'Moment Timezone ' +
          a.tz.version +
          ' was already loaded ' +
          (a.tz.dataVersion ? 'with data from ' : 'without any data') +
          a.tz.dataVersion
      ),
      a
    );
    ...
    (q.prototype = {
      ...
      _index: function(a) {
        var d,
          b = +a,
          c = this.untils;
        for (d = 0; d < c.length; d++) if (b < c[d]) return d;
      },
      parse: function(a) {
        var f,
          g,
        ...
        for (i = 0; i < e; i++)
          if (
            ...
            (g = c[i + 1]),
            (h = c[i ? i - 1 : i]),
            f < g && J.moveAmbiguousForward
              ? (f = g)
              : f > h && J.moveInvalidForward && (f = h),
            b < d[i] - 6e4 * f)
          )
            return c[i];
        return c[e];
    ...
    (a.updateOffset = function(b, c) {
      ...
      void 0 === b._z &&
        (d &&
          H(b) &&
          !b._isUTC &&
          ((b._d = a.utc(b._a)._d), b.utc().add(d.parse(b), 'minutes')),
        (b._z = d)),
        b._z &&
          ((e = b._z.offset(b)),
          Math.abs(e) < 16 && (e /= 60),
          void 0 !== b.utcOffset ? b.utcOffset(-e, c) : b.zone(e, c));
    }),
    (K.tz = function(b) {
      return b
        ? ((this._z = C(b)),
          ...
          this)
        : this._z ? this._z.name : void 0;
    }),
    (K.zoneName = L(K.zoneName)),
    (K.zoneAbbr = L(K.zoneAbbr)),
    (K.utc = M(K.utc)),
