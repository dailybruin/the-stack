...
(function(t, n) {
  ...
  function A(t) {
    return (t = +t) < Nf
      ...
      : t < Sf
        ? qf * (t -= kf) * t + Ef
        : t < Cf ? qf * (t -= Af) * t + zf : qf * (t -= Pf) * t + Rf;
  }
  function C(t) {
                ...
                : (n = qh.exec(t))
                  ...
                  : (n = Lh.exec(t))
                    ...
                    : (n = Uh.exec(t))
                      ...
                      : Dh.hasOwnProperty(t)
                        ? jt(Dh[t])
                        : 'transparent' === t ? new Wt(NaN, NaN, NaN, 0) : null
    );
  }
  function jt(t) {
  ...
  function Kt(t) {
    ...
    var e = un(t.r),
      r = un(t.g),
      i = un(t.b),
      o = en((0.4124564 * e + 0.3575761 * r + 0.1804375 * i) / Yh),
      u = en((0.2126729 * e + 0.7151522 * r + 0.072175 * i) / Bh),
      a = en((0.0193339 * e + 0.119192 * r + 0.9503041 * i) / jh);
  ...
  function wn(t) {
    return 'none' === t
      ...
      : (ep ||
        ...
        (t = ip
          .getComputedStyle(rp.appendChild(ep), null)
  ...
  function Mn(t) {
    return null == t
      ? wp
      : (op ||
          (op = document.createElementNS('http://www.w3.org/2000/svg', 'g')),
        op.setAttribute('transform', t),
        (t = op.transform.baseVal.consolidate())
          ? ((t = t.matrix), Mp(t.a, t.b, t.c, t.d, t.e, t.f))
          : wp);
  }
  function Tn(t, n, e, r) {
    function i(t) {
    ...
    function u(t, n, e, o) {
      t !== n
        ? (t - n > 180 ? (n += 360) : n - t > 180 && (t += 360),
          o.push({ i: e.push(i(e) + 'rotate(', null, r) - 2, x: dp(t, n) }))
        : n && e.push(i(e) + 'rotate(' + n + r);
    }
    function a(t, n, e, o) {
      t !== n
        ? o.push({ i: e.push(i(e) + 'skewX(', null, r) - 2, x: dp(t, n) })
  ...
  function Wn() {
    jn(), ++ad;
    for (var t, n = Fp; n; )
      (t = hd - n._time) >= 0 && n._call.call(null, t), (n = n._next);
    --ad;
  }
  function $n() {
  ...
  function Gn() {
    for (var t, n, e = Fp, r = 1 / 0; e; )
      e._call
        ...
        : ((n = e._next), (e._next = null), (e = t ? (t._next = n) : (Fp = n)));
    (Ip = t), Jn(r);
  }
  function Jn(t) {
    if (!ad) {
      ...
      var n = t - hd;
      n > 24
        ? (t < 1 / 0 && (cd = setTimeout($n, n)),
          sd && (sd = clearInterval(sd)))
        : (sd || (sd = setInterval(Zn, fd)), (ad = 1), vd($n));
    }
  }
  function Qn(t, n, e, r) {
    function i(n) {
    ...
    return (
      ...
      e &&
        ((i.count = function(n, r) {
          return (
            gd.setTime(+n), md.setTime(+r), t(gd), t(md), Math.floor(e(gd, md))
          );
        }),
        (i.every = function(t) {
          return (
  ...
  function Kn(t) {
    return Qn(
      ...
      function(t, n) {
        return (
          (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * Md) / kd
        );
      }
    );
  }
  ...
  function Cr() {
    ...
    return (
      (t.domain = function(i) {
        return arguments.length
          ? ((n = Zv.call(i)), (r = Math.min(n.length, e.length - 1)), t)
          : n.slice();
      }),
      (t.range = function(i) {
        return arguments.length
          ? ((e = Zv.call(i)), (r = Math.min(n.length, e.length - 1)), t)
          : e.slice();
      }),
      (t.invertExtent = function(t) {
        var r = e.indexOf(t);
  ...
  function Ur(t) {
    return function() {
      var n = this.ownerDocument,
        e = this.namespaceURI;
      return e === N_ && n.documentElement.namespaceURI === N_
        ? n.createElement(t)
  ...
  function Gr(t, n, e, r, i, o, u) {
    ...
    for (a = 0; a < l; ++a)
      (c = n[a]) &&
        ((p[a] = s = $_ + u.call(c, c.__data__, a, n)),
        s in f ? (i[a] = c) : (f[s] = c));
    for (a = 0; a < h; ++a)
        ...
        if (((h = c[s]), h.name === e.name)) {
          ...
          h.state === zy
            ? ((h.state = Ry),
              ...
              delete c[s])
            : +s < n && ((h.state = Ry), h.timer.stop(), delete c[s]);
        }
      if (
        (_d(function() {
          e.state === Cy &&
            ((e.state = zy), e.timer.restart(o, e.delay, e.time), o(r));
        }),
        (e.state = Ay),
        ...
        for (
          e.state = Cy, a = new Array((l = e.tween.length)), s = 0, f = -1;
          s < l;
          ++s
        )
      ...
      for (
        var r =
            n < e.duration
              ...
              : (e.timer.restart(u), (e.state = Py), 1),
          i = -1,
          o = a.length;
        ++i < o;
  ...
  function go(t, n) {
      ...
      (m = m.merge(
        ...
        (T = T.merge(
          w
            ...
            .attr(s, N * h)
            .attr(k, 0.5)
            .attr('dy', t === fg ? '0em' : t === hg ? '0.71em' : '0.32em')
        )),
        e !== g &&
          ((m = m.transition(e)),
          (x = x.transition(e)),
    ...
    return (
      ...
      (e.tickArguments = function(t) {
        return arguments.length
          ? ((r = null == t ? [] : cg.call(t)), e)
          : r.slice();
      }),
      (e.tickValues = function(t) {
        return arguments.length
          ? ((i = null == t ? null : cg.call(t)), e)
          : i && i.slice();
      }),
  ...
  function lu(t, n, e, r, i, o) {
    for (
      ...
      y.push((u = { value: f, dice: c < s, children: g.slice(m, x) })),
        u.dice
          ? Pg(u, e, r, i, w ? (r += s * f / w) : o)
          : Fg(u, e, r, w ? (e += c * f / w) : i, o),
        (w -= f),
        (m = x);
    }
    return y;
  ...
  function Uu(t, n, e, r) {
    for (var i, o = hm.length; o--; )
      (Lu((i = hm[o]), t, n, e, r) &&
        qu(i, t, n, e, r) &&
        (Math.abs(i[0][0] - i[1][0]) > vm ||
          Math.abs(i[0][1] - i[1][1]) > vm)) ||
        delete hm[o];
  }
  function Du(t) {
      ...
      if ((o = fm[i])) {
        ...
        for (a = 0, s = c.length; a < s; )
          (p = Iu(o, hm[c[a]])),
            ...
            (l = f[0]),
            (h = f[1]),
            (Math.abs(d - l) > vm || Math.abs(v - h) > vm) &&
              (c.splice(
                a,
                0,
                hm.push(
                  Pu(
                    u,
                    p,
                    Math.abs(d - t) < vm && r - v > vm
                      ? [t, Math.abs(l - t) < vm ? h : r]
                      : Math.abs(v - r) < vm && e - d > vm
                        ? [Math.abs(h - r) < vm ? l : e, r]
                        : Math.abs(d - e) < vm && v - n > vm
                          ? [e, Math.abs(l - e) < vm ? h : n]
                          : Math.abs(v - n) < vm && d - t > vm
                            ? [Math.abs(h - n) < vm ? l : t, n]
                            : null
                  )
                ) - 1
              ),
  ...
  function Xu(t) {
    var n = t.circle;
    n &&
      (n.P || (cm = n.N), lm.remove(n), pm.push(n), Su(n), (t.circle = null));
  }
  function Vu() {
  ...
  function Zu(t) {
    ...
    for (
      var c = o;
      c.circle &&
      Math.abs(e - c.circle.x) < vm &&
      Math.abs(r - c.circle.cy) < vm;
    ...
    for (
      var s = u;
      s.circle &&
      Math.abs(e - s.circle.x) < vm &&
      Math.abs(r - s.circle.cy) < vm;
    ...
    var f,
      l = a.length;
    for (f = 1; f < l; ++f)
      (s = a[f]), (c = a[f - 1]), Ru(s.edge, c.site, s.site, i);
    (c = a[0]),
      (s = a[l - 1]),
  ...
  function na(t, n) {
    ...
    for (hm = [], fm = new Array(t.length), sm = new ku(), lm = new ku(); ; )
      if (((i = cm), o && (!i || o[1] < i.y || (o[1] === i.y && o[0] < i.x))))
  ...
  function ga(n) {
      ...
      function o() {
        ...
        _ < h &&
          ...
          (z[0][0] === h && z[0][1] === d && z[1][0] === _ && z[1][1] === g) ||
            ((A.selection = [[h, d], [_, g]]), r.call(T), F.brush());
      }
      function u() {
        ...
        I.attr('pointer-events', 'all'),
          ...
          A.selection && (z = A.selection),
          da(z) && ((A.selection = null), r.call(T)),
          F.end();
      }
      function a() {
    ...
    return (
      ...
      (o.prototype = {
        ...
        emit: function(t) {
          Xr(new Mm(e, t, n.output(this.state.selection)), l.apply, l, [
            t,
            this.that,
            this.args,
          ]);
      ...
      (e.extent = function(t) {
        return arguments.length
          ? ((s =
              'function' == typeof t
                ? t
                : wm([[+t[0][0], +t[0][1]], [+t[1][0], +t[1][1]]])),
            e)
          : s;
      }),
      (e.filter = function(t) {
        return arguments.length
          ? ((f = 'function' == typeof t ? t : wm(!!t)), e)
          : f;
      }),
  ...
  function Va(t, n) {
    ...
    if (ax) {
      ...
      f ^ (c * ix < s && s < c * t)
        ...
        f
          ? t < ix
            ? Qa(tx, t) > Qa(tx, ex) && (ex = t)
            : Qa(t, ex) > Qa(tx, ex) && (tx = t)
          : ex >= tx
            ? (t < tx && (tx = t), t > ex && (ex = t))
            : t > ix
              ? Qa(tx, t) > Qa(tx, ex) && (ex = t)
  ...
  function _c(t, n, e, r, i, o) {
    if (e) {
      ...
      for (var s, f = i; r > 0 ? f > o : f < o; f -= c)
        (s = Oa([u, -a * Ox(f), -a * jx(f)])), t.point(s[0], s[1]);
    }
  }
  function yc(t, n) {
    (n = Fa(n)), (n[0] -= t), Ha(n);
    ...
    return function(u) {
      ...
      function d(o, u) {
        ...
        if ((_ && y.push([o, u]), T))
          ...
          var c = [
              (b = Math.max(Nb, Math.min(Tb, b))),
              (w = Math.max(Nb, Math.min(Tb, w))),
            ],
            s = [
              (o = Math.max(Nb, Math.min(Tb, o))),
              (u = Math.max(Nb, Math.min(Tb, u))),
            ];
          bb(c, s, t, n, e, r)
  ...
  function Sc() {
    ...
    function n() {
      return Os(Fx(o / _) * _, i, _)
        .map(h)
        .concat(Os(Fx(s / y) * y, c, y).map(p))
        .concat(
          Os(Fx(r / d) * d, e, d)
            .filter(function(t) {
              return Lx(t % _) > Sx;
    ...
    return (
      ...
      t
        .extentMajor([[-180, -90 + Sx], [180, 90 - Sx]])
        .extentMinor([[-180, -80 - Sx], [180, 80 + Sx]])
    );
  }
  function Ec() {
    return Sc()();
  ...
  function Wc(t, n) {
    return (
      ((t = t.x)[0] < 0 ? t[1] - Cx - Sx : Cx - t[1]) -
      ((n = n.x)[0] < 0 ? n[1] - Cx - Sx : Cx - n[1])
    );
  }
  function $c(t) {
    var n,
  ...
  function Zc(t, n, e, r) {
    ...
    return Lx(u) > Sx
      ? Ux(
          (jx(n) * (o = Ox(r)) * jx(e) - jx(r) * (i = Ox(n)) * jx(t)) /
            (i * o * u)
        )
      : (n + r) / 2;
  }
  ...
  function is(t) {
    ...
    return (
      ...
      (n.clipAngle = function(t) {
        return arguments.length
          ? ((N = +t ? iw((T = t * qx), 6 * qx) : ((T = null), rw)), o())
          : T * Rx;
      }),
  ...
  var ws = '4.4.0',
        ...
        (t.thresholds = function(n) {
          return arguments.length
            ? ((r =
                'function' == typeof n
                  ? n
                  : Us(Array.isArray(n) ? qs.call(n) : n)),
              t)
            : r;
        }),
        t
    ...
    Zs = function(t, n) {
      var e,
        ...
        o = -1,
        u = i;
      if (null == n) for (; ++o < i; ) isNaN((e = As(t[o]))) ? --u : (r += e);
      else for (; ++o < i; ) isNaN((e = As(n(t[o], o, t)))) ? --u : (r += e);
      if (u) return r / u;
    },
    Gs = function(t, n) {
      var e,
        ...
        i = t.length,
        o = -1;
      if (null == n) for (; ++o < i; ) isNaN((e = As(t[o]))) || r.push(e);
      else for (; ++o < i; ) isNaN((e = As(n(t[o], o, t)))) || r.push(e);
      ...
      lineEnd: function() {
        ...
        if (e)
          if (
            ...
            for (var r = qt(t), i = qt(n), o = 0, u = 1; u < e; ++o, ++u)
  ...
  var ep,
    ...
    gp = function(t, n) {
      var e,
        ...
        a = [],
        c = [];
      for (t += '', n += ''; (e = _p.exec(t)) && (r = yp.exec(n)); )
        (i = r.index) > o &&
          ((i = n.slice(o, i)), a[u] ? (a[u] += i) : (a[++u] = i)),
          (e = e[0]) === (r = r[0])
            ? a[u] ? (a[u] += r) : (a[++u] = r)
            : ((a[++u] = null), c.push({ i: u, x: dp(e, r) })),
          (o = yp.lastIndex);
      return (
        ...
        : ('number' === r
            ...
            : 'string' === r
              ...
              : n instanceof Bt
                ...
                : n instanceof Date
                  ? pp
                  : Array.isArray(n) ? hp : isNaN(n) ? vp : dp)(t, n);
    },
    xp = function(t, n) {
      return (
        (t = +t),
  ...
  Xn.prototype = Vn.prototype = {
    ...
    restart: function(t, n, e) {
      ...
      (e = (null == e ? jn() : +e) + (null == n ? 0 : +n)),
        this._next ||
          Ip === this ||
          (Ip ? (Ip._next = this) : (Fp = this), (Ip = this)),
        (this._call = t),
        (this._time = e),
        Jn();
    },
  ...
  var bd = xd.range,
    ...
    Rd = Qn(
      ...
      function(t, n) {
        return (
          (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * Md) / Nd
        );
      },
      function(t) {
        return t.getDate() - 1;
  ...
  var Uv,
    ...
    Ov = function(t, n) {
      return Math.max(
        0,
        3 * Math.max(-8, Math.min(8, Math.floor(Nv(n) / 3))) - Nv(Math.abs(t))
      );
    },
    Fv = function(t, n) {
      return (
        (t = Math.abs(t)), (n = Math.abs(n) - t), Math.max(0, Nv(n) - Nv(t)) + 1
      );
    },
    Iv = { '-': '', _: ' ', 0: '0' },
    Yv = /^\s*\d+/,
  ...
  var Hv = '%Y-%m-%dT%H:%M:%S.%LZ',
    ...
    c_ = 365 * o_,
    s_ = function() {
      return Rr(Jd, Zd, Ld, Rd, zd, Ad, Sd, xd, t.timeFormat).domain([
        new Date(2e3, 0, 1),
        new Date(2e3, 0, 2),
      ]);
    },
    f_ = function() {
      return Rr(bv, mv, ov, rv, nv, Kd, Sd, xd, t.utcFormat).domain([
        Date.UTC(2e3, 0, 1),
        Date.UTC(2e3, 0, 2),
      ]);
    },
    ...
    __ = Up(ln(300, 0.5, 0), ln(-240, 0.5, 1)),
    y_ = Up(ln(-100, 0.75, 0.35), ln(80, 1.5, 0.8)),
    g_ = Up(ln(260, 0.75, 0.35), ln(80, 1.5, 0.8)),
    m_ = ln(),
    x_ = function(t) {
    ...
    S_ = function(t) {
      ...
      return (
        ...
        k_.hasOwnProperty(n) ? { space: k_[n], local: t } : t
      );
    },
    E_ = function(t) {
      var n = S_(t);
  ...
  if ('undefined' != typeof document) {
    ...
    if (!z_.matches) {
      var P_ =
        z_.webkitMatchesSelector ||
        z_.msMatchesSelector ||
        z_.mozMatchesSelector ||
        z_.oMatchesSelector;
      C_ = function(t) {
        return function() {
  ...
  if (((t.event = null), 'undefined' != typeof document)) {
    ...
    'onmouseenter' in L_ ||
      (q_ = { mouseenter: 'mouseover', mouseleave: 'mouseout' });
  }
  ...
  var W_ = function(t) {
    ...
    uy = function(t, n) {
      ...
      return this.each(
        (null == n
          ? e.local ? Kr : Qr
          : 'function' == typeof n ? (e.local ? ri : ei) : e.local ? ni : ti)(
          e,
          n
        )
      );
  ...
  var by = function(t) {
    ...
    Dy = function(t, n) {
      ...
      if (((t += ''), arguments.length < 2)) {
        for (
          var r, i = Li(this.node(), e).tween, o = 0, u = i.length;
          o < u;
          ++o
        )
    ...
    Oy = function(t, n) {
      ...
      return ('number' == typeof n
        ? dp
        : n instanceof Bt ? sp : (e = Bt(n)) ? ((n = e), sp) : gp)(t, n);
    },
    Fy = function(t, n) {
      var e = S_(t),
        r = 'transform' === e ? Np : Oy;
      return this.attrTween(
        ...
        'function' == typeof n
          ...
          : null == n ? (e.local ? Yi : Ii)(e) : (e.local ? ji : Bi)(e, r, n)
      );
    },
    Iy = function(t, n) {
      var e = 'attr.' + t;
    ...
    Yy = function(t) {
      ...
      return arguments.length
        ...
        : Li(this.node(), n).delay;
    },
    By = function(t) {
      var n = this._id;
      return arguments.length
        ? this.each(('function' == typeof t ? Gi : Ji)(n, t))
        : Li(this.node(), n).duration;
    },
    jy = function(t) {
      var n = this._id;
  ...
  var ig = { time: null, delay: 0, duration: 250, ease: g },
    og = function(t) {
      ...
      t instanceof so
        ? ((n = t._id), (t = t._name))
        : ((n = lo()), ((e = ig).time = jn()), (t = null == t ? null : t + ''));
  ...
  var kg = function(t) {
    ...
    Rg = function() {
      ...
      function n(t, n) {
        return function(e) {
          e.children &&
            Pg(e, e.x0, t * (e.depth + 1) / n, e.x1, t * (e.depth + 2) / n);
          var r = e.x0,
            o = e.y0,
            u = e.x1 - i,
            a = e.y1 - i;
  ...
  var Og = function() {
    ...
    Bg = function() {
      ...
      return (
        ...
        (t.paddingTop = function(n) {
          return arguments.length
            ? ((c = 'function' == typeof n ? n : Ag(+n)), t)
            : c;
        }),
        (t.paddingRight = function(n) {
          return arguments.length
            ? ((s = 'function' == typeof n ? n : Ag(+n)), t)
            : s;
        }),
        (t.paddingBottom = function(n) {
          return arguments.length
            ? ((f = 'function' == typeof n ? n : Ag(+n)), t)
            : f;
        }),
        (t.paddingLeft = function(n) {
          return arguments.length
            ? ((l = 'function' == typeof n ? n : Ag(+n)), t)
            : l;
        }),
        t
      );
        ...
        if ((u = t._squarify) && u.ratio === n)
          for (
            ...
            for (
              ...
              a.value += c[s].value;
            a.dice
              ? Pg(a, e, r, i, (r += (o - r) * a.value / p))
              : Fg(a, e, r, (e += (i - e) * a.value / p), o),
              (p -= a.value);
          }
    ...
    Zg = function(t) {
      ...
      var i,
        ...
        a = 1;
      return (
        'function' != typeof t && (t = Wg(null == t ? 1 : +t)),
        ...
        (n.radius = function(e) {
          return arguments.length
            ? ((t = 'function' == typeof e ? e : Wg(+e)), r(), n)
            : t;
        }),
        n
      );
    ...
    Gg = function(t) {
      ...
      return (
        ...
        (e.strength = function(t) {
          return arguments.length
            ? ((p = 'function' == typeof t ? t : Wg(+t)), i(), e)
            : p;
        }),
        (e.distance = function(t) {
          return arguments.length
            ? ((d = 'function' == typeof t ? t : Wg(+t)), u(), e)
            : d;
        }),
        e
      );
    ...
    tm = function() {
      ...
      return (
        ...
        (t.strength = function(e) {
          return arguments.length
            ? ((c = 'function' == typeof e ? e : Wg(+e)), n(), t)
            : c;
        }),
    ...
    nm = function(t) {
      ...
      var r,
        ...
        u = Wg(0.1);
      return (
        'function' != typeof t && (t = Wg(null == t ? 0 : +t)),
        (n.initialize = function(t) {
          (r = t), e();
        }),
        (n.strength = function(t) {
          return arguments.length
            ? ((u = 'function' == typeof t ? t : Wg(+t)), e(), n)
            : u;
        }),
        (n.x = function(r) {
          return arguments.length
            ? ((t = 'function' == typeof r ? r : Wg(+r)), e(), n)
            : t;
        }),
        n
      );
  ...
  var um = function() {
      ...
      function o() {
        if (l.apply(this, arguments)) {
          var n,
            ...
            o = r.length;
          for (n = 0; n < o; ++n)
            (e = c(r[n].identifier, i, My, this, arguments)) &&
              (gu(), e('start'));
        }
      }
      function u() {
      ...
      return (
        (n.filter = function(t) {
          return arguments.length
            ? ((l = 'function' == typeof t ? t : om(!!t)), n)
            : l;
        }),
        (n.container = function(t) {
          return arguments.length
            ? ((h = 'function' == typeof t ? t : om(t)), n)
            : h;
        }),
        (n.subject = function(t) {
          return arguments.length
            ? ((p = 'function' == typeof t ? t : om(t)), n)
            : p;
        }),
        (n.on = function() {
      ...
      if (
        ...
        do {
          ...
          if (t === i.L) {
            if (
              ((n = i.R),
              n.C && ((n.C = !1), (i.C = !0), Eu(this, i), (n = i.R)),
              (n.L && n.L.C) || (n.R && n.R.C))
            ) {
              (n.R && n.R.C) ||
                ((n.L.C = !1), (n.C = !0), Au(this, n), (n = i.R)),
                (n.C = i.C),
                (i.C = n.R.C = !1),
                Eu(this, i),
                (t = this._);
            ...
            ((n = i.L),
            n.C && ((n.C = !1), (i.C = !0), Au(this, i), (n = i.L)),
            (n.L && n.L.C) || (n.R && n.R.C))
          ) {
            (n.L && n.L.C) ||
              ((n.R.C = !1), (n.C = !0), Eu(this, n), (n = i.L)),
              (n.C = i.C),
              (i.C = n.L.C = !1),
              Au(this, i),
              (t = this._);
  ...
  var ym = function() {
      function t(t) {
        return new na(
          t.map(function(r, i) {
            var o = [
              Math.round(n(r, i, t) / vm) * vm,
              Math.round(e(r, i, t) / vm) * vm,
            ];
      ...
      return (
        ...
        (t.x = function(e) {
          return arguments.length
            ? ((n = 'function' == typeof e ? e : am(+e)), t)
            : n;
        }),
        (t.y = function(n) {
          return arguments.length
            ? ((e = 'function' == typeof n ? n : am(+n)), t)
            : e;
        }),
        (t.extent = function(n) {
          return arguments.length
    ...
    bm = function() {
        ...
        function n() {
          xm(),
            ...
            o.zoom(
              'mouse',
              i(
                r(o.that.__zoom, (o.mouse[0] = F_(o.that)), o.mouse[1]),
                o.extent
              )
            );
        }
      ...
      function p() {
        var n,
          ...
          l = f.length;
        for (xm(), v && (v = clearTimeout(v)), n = 0; n < l; ++n)
          (o = f[n]),
      ...
      return (
        ...
        (c.prototype = {
          ...
          emit: function(t) {
            Xr(new ea(n, t, this.that.__zoom), E.apply, E, [
              t,
              this.that,
              this.args,
            ]);
    ...
    Wm = function() {
      function t() {
        ...
        if (
          ...
          u.arc(0, 0, f, l, h),
          (l === _ && h === y) ||
            (u.quadraticCurveTo(0, 0, v * Om(_), v * Fm(_)),
            u.arc(0, 0, v, _, y)),
      ...
      return (
        (t.radius = function(n) {
          return arguments.length
            ? ((r = 'function' == typeof n ? n : Vm(+n)), t)
            : r;
        }),
        (t.startAngle = function(n) {
          return arguments.length
            ? ((i = 'function' == typeof n ? n : Vm(+n)), t)
            : i;
        }),
        (t.endAngle = function(n) {
          return arguments.length
            ? ((o = 'function' == typeof n ? n : Vm(+n)), t)
            : o;
        }),
        (t.source = function(e) {
          return arguments.length ? ((n = e), t) : n;
  ...
  var Zm,
    ...
    eb = function(t) {
      var n, e, r, i, o, u, a;
      if (
        ((rx = ex = -(tx = nx = 1 / 0)), (cx = []), Zx(t, nb), (e = cx.length))
      ) {
        for (cx.sort(Ka), n = 1, r = cx[0], o = [r]; n < e; ++n)
          (i = cx[n]),
            tc(r, i[0]) || tc(r, i[1])
        ...
        for (
          ...
          (i = o[n]),
            (a = Qa(r[1], i[0])) > u && ((u = a), (tx = i[0]), (ex = r[1]));
      }
      return (
        (cx = sx = null),
        tx === 1 / 0 || nx === 1 / 0
    ...
    ib = function(t) {
      ...
      return i < Ex &&
        ...
        (e = _x),
        (r = yx),
        lx < Sx && ((n = hx), (e = px), (r = dx)),
        (i = n * n + e * e + r * r),
        i < Ex)
        ? [NaN, NaN]
        : [Dx(e, n) * Rx, Ea(r / Xx(i)) * Rx];
    },
    ob = function(t) {
      return function() {
        return t;
  ...
  var ab,
    ...
    gb = function(t) {
      ...
      return (
        (t = hc(t[0] * qx, t[1] * qx, t.length > 2 ? t[2] * qx : 0)),
        (n.invert = function(n) {
          return (
            (n = t.invert(n[0] * qx, n[1] * qx)), (n[0] *= Rx), (n[1] *= Rx), n
          );
        }),
        n
      );
    ...
    mb = function() {
      ...
      return (
        (n.center = function(t) {
          return arguments.length
            ? ((i = 'function' == typeof t ? t : ob([+t[0], +t[1]])), n)
            : i;
        }),
        (n.radius = function(t) {
          return arguments.length
            ? ((o = 'function' == typeof t ? t : ob(+t)), n)
            : o;
        }),
        (n.precision = function(t) {
          return arguments.length
            ? ((u = 'function' == typeof t ? t : ob(+t)), n)
            : u;
        }),
        n
      );
    ...
    Qb = {
      ...
      result: function() {
        var t = Jb
          ? [Zb / Jb, Gb / Jb]
          : $b ? [Vb / $b, Wb / $b] : Xb ? [jb / Xb, Hb / Xb] : [NaN, NaN];
  ...
  var Kb = function(t, n) {
      ...
      return (
        ...
        (e.projection = function(n) {
          return arguments.length
            ? ((r = null == n ? ((t = null), qb) : (t = n).stream), e)
            : t;
        }),
        (e.context = function(t) {
          return arguments.length
            ? ((i = null == t ? ((n = null), new Hc()) : new jc((n = t))),
        ...
        var p,
          ...
          b = {
            ...
            polygonEnd: function() {
              ...
              var t = nw(p, y);
              d.length
                ? (x || (o.polygonStart(), (x = !0)), Mb(d, Wc, t, e, o))
                : t &&
        ...
        (t.translate = function(t) {
          ...
          return (
            ...
            (o = s
              ...
              .clipExtent([
                [r - 0.425 * e + Sx, a + 0.12 * e + Sx],
                [r - 0.214 * e - Sx, a + 0.234 * e - Sx],
              ])
              .stream(l)),
            (u = f
              .translate([r - 0.205 * e, a + 0.212 * e])
              .clipExtent([
                [r - 0.214 * e + Sx, a + 0.166 * e + Sx],
                [r - 0.115 * e - Sx, a + 0.234 * e - Sx],
              ])
              .stream(l)),
            n()
          );
  ...
  var bw = function() {
    ...
    ww = function() {
      ...
      return (u = {
        ...
        scale: function(n) {
          return arguments.length
            ? ((h = gs((a = +n) * f, a * l, c, s)), t())
            : a;
        },
        translate: function(n) {
          return arguments.length
            ? ((h = gs(a * f, a * l, (c = +n[0]), (s = +n[1]))), t())
            : [c, s];
        },
        reflectX: function(n) {
          return arguments.length
            ? ((h = gs(a * (f = n ? -1 : 1), a * l, c, s)), t())
            : f < 0;
        },
        reflectY: function(n) {
          return arguments.length
            ? ((h = gs(a * f, a * (l = n ? -1 : 1), c, s)), t())
            : l < 0;
        },
