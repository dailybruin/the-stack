...
const ctxPIE_bfit = document.getElementById('bfit_member_pie').getContext('2d');
...
if (window.matchMedia('(max-width: 480px)').matches) {
  chart_bfit.canvas.style = 'max-height:300px';
  chart_bfit.options.legend.position = 'top';
  chart_bfit.options.maintainAspectRatio = false;
  chart_bfit.update();
}
