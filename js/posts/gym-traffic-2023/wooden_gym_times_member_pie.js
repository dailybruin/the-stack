  ...
  const labels_Wooden = ['Undergraduate', 'Student Affiliate','Retiree & Emeriti', 'Conference Guest']; //THIS SHOULD BE A LIST OF WHAT EACH SEGMENT IN THE PIE REPRESENTS
  const member_colors_Wooden = ['rgb(28, 93, 153)','rgb(232, 107, 146)', 'rgb(114, 150, 108)', 'rgb(255, 200, 87)'] //CHANGE THESE TO WHAT MATCHES THE SUBJECT
  const data_Wooden = {
  ...
  const ctxPIE_Wooden = document.getElementById('wooden_member_demo_gym_times').getContext('2d');
