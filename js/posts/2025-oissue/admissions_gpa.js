...
const options = {
  ...
  plugins: {
    ...
    subtitle: {
        display: true,
        text: ['The average GPA for in-state admitted students in 2024 was 4.24.', 'Each bar represents the average GPA of admitted students for a county. Each point represents the average GPA of applicants for a county.', 'The average admitted GPA of a county was always higher than the average application GPA of that county.'],
        font: {
          size: 15,
        },
        padding: {
