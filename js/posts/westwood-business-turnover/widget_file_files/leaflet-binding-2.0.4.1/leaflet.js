          ...
          switch (window.location.protocol) {
            case 'http:':
              ...
              _leaflet2['default'].Icon.Default.imagePath =
                'http://cdn.leafletjs.com/leaflet/v1.3.1/images/';
              break;
  ...
  */
    ...
    13: [
      function(require, module, exports) {
        ...
        if (_htmlwidgets2['default'].shinyMode) {
          _shiny2['default'].addCustomMessageHandler('leaflet-calls', function(
            data
          ) {
            var id = data.id;
            ...
            _createClass(LayerManager, [
              ...
              },
              {
                ...
                value: function getLayerGroup(group, ensureExists) {
                  ...
                  if (ensureExists && !g) {
                    this._byGroup[group] = this._byGroup[group] || {};
                    g = this._groupContainers[group] = _leaflet2[
                      'default'
                    ].featureGroup();
                    g.groupname = group;
                    g.addTo(this._map);
              ...
              },
              {
                ...
                value: function getVisibleGroups() {
                  ...
                  _jquery2['default'].each(this._groupContainers, function(
                    k,
                    v
                  ) {
        ...
        (function(global) {
          ...
          function addMarkers(
            ...
            (function() {
              ...
              if (cluster && !clusterGroup) {
                clusterGroup = _leaflet2[
                  'default'
                ].markerClusterGroup.layerSupport(clusterOptions);
          ...
          methods.addMarkers = function(
            ...
            if (
              ...
              addMarkers(this, df, group, clusterOptions, clusterId, function(
                df,
                i
              ) {
          ...
          methods.addLegend = function(options) {
            ...
            legend.onAdd = function(map) {
              ...
              if (options.type === 'numeric') {
                ...
                var singleBinPct =
                  (options.extra.p_n - options.extra.p_1) / (labels.length - 1); // Each bin is `singleBinHeight` high. How tall is the gradient?
          ...
          methods.addLayersControl = function(
            ...
            _jquery2['default'].each((0, _util.asArray)(baseGroups), function(
              i,
              g
            ) {
