...
const strike_length_labels = ['2012','2013','2014','2015','2016', '2017', '2018', '2019', '2020', '2021', '2022']; //THIS SHOULD BE A LIST OF WHAT YOU WANT ON THE X-AXIS


const strike_length_data = {
  labels: strike_length_labels,
  datasets: [{
...
const strike_length_chart = new Chart(strike_length, {
    type: 'line',
    data: strike_length_data,
    options: strike_length_options
  });