...
const labels = ['SEGMENT','LABELS','FOR','PIE','CHART']; //THIS SHOULD BE A LIST OF WHAT EACH SEGMENT IN THE PIE REPRESENTS
...
const data = {
  ...
  datasets: [{
    ...
    data:[1,2,3], //VALUE FOR EACH SEGMENT
...
const ctxPIE = document.getElementById('BethanysPie');
