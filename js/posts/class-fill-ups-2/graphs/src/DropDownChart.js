$(document).ready(function() {
  ...
  $('#chartMD_winter').css({'opacity':100}).show();
  var checkExist1 = setInterval(function() {
   if (($('#chartMD_winter').text() != 'Graph loading')
...
$('#chartMD_fall').css({'opacity':0}).show();
...
$('#chartMD_spring').css({'opacity':0}).show();
