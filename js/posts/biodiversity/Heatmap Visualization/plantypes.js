...
const labels = ['Shrubs', 'Trees', 'Forbs', 'Grasses and Sedges', 'Annuals','Vines', 'Succulents']; //THIS SHOULD BE A LIST OF WHAT EACH SEGMENT IN THE PIE REPRESENTS
const colors = ['rgb(21, 139, 231)', 'rgb(231, 171, 21)', 'rgb(231, 59, 21)','rgb(132, 21, 231)','rgb(21, 231, 50)', 'rgb(114, 150, 108)','rgb(204, 147, 237)'] //CHANGE THESE TO WHAT MATCHES THE SUBJECT 
const data = {
  labels: labels,
