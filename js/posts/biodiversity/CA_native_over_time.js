...
const labels = ['2016','2017','2018','2019','2020','2021','2022']; //THIS SHOULD BE A LIST OF WHAT YOU WANT ON THE X-AXIS
const colors = ['#5FA0CE', '#E5A539'] //CHANGE THESE TO WHAT MATCHES THE SUBJECT
const data = {
  labels: labels,
