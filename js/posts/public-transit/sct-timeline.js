const sctData = [
  {
    hovertemplate: 'Line 792<br>%{x}<br>Number of riders: %{y}<extra></extra>',
  ...
  {
    hovertemplate: 'Line 797<br>%{x}<br>Number of riders: %{y}<extra></extra>',
...
Plotly.newPlot('sct-timeline', sctData, sctLayout, options);
