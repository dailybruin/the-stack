      ...
      var myPlot = document.getElementById('myDiv'),
        ...
        var data = [{ 
          x: ['Fall 2016', 'Fall 2017', 'Fall 2018'], /* Quarter */ 
          y: [50, 46, 43], /* Acceptance Rate */
        name: 'Overall', /* Section */
        mode: 'lines+markers', /* shows line and point */
        ...
        hoverinfo: "text", /* shows the above on hover */
          line: {width: 3},  /* width of lines */
          marker: {color: '#000'} /* color of line */
        }, {
        ...
        var layout = {
          plot_bgcolor: '#fff', /* background color */
          paper_bgcolor: '#fff',
          width: 1000,
          ...
          legend: {
            ...
            bgcolor: '#9BD1E5',
            bordercolor: '#6A8EAE',
            x: -0.27, /* position of legend is lower left */
            y: 0.5, /* see above */
          },
          hovermode: 'closest',
          height: 700
