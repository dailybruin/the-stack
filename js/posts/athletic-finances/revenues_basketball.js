...
const data = {
  ...
  datasets: [{
    label: 'Womens',
    data: [5635343, 5687731, 1330479], //VALUE FOR EACH BAR
    backgroundColor: colors[0],
    borderColor: colors[0],
    borderWidth: 1
  },{
    label: 'Mens',
    data: [12891320, 7241439, 8487064], //DATA HERE
...
const options = {
  ...
  plugins: {
    title: {
        display: true,
        text: 'Revenues of Mens and Womens Basketball Teams'
      },
  },
...
const ctxBAR = document.getElementById('revenues');
